...
package com.aaron.aaronlibrary.widget.subscaleview;
...
import com.aaron.aaronlibrary.widget.subscaleview.decoder.CompatDecoderFactory;
import com.aaron.aaronlibrary.widget.subscaleview.decoder.DecoderFactory;
import com.aaron.aaronlibrary.widget.subscaleview.decoder.ImageDecoder;
import com.aaron.aaronlibrary.widget.subscaleview.decoder.ImageRegionDecoder;
import com.aaron.aaronlibrary.widget.subscaleview.decoder.SkiaImageDecoder;
import com.aaron.aaronlibrary.widget.subscaleview.decoder.SkiaImageRegionDecoder;
...
public class SubsamplingScaleImageView extends View {
    ...
    private boolean checkImageLoaded() {
        ...
        if (!imageLoadedSent && imageLoaded) {
            ...
            float maxWidth = maxScale * sWidth();
            int screenW = AppInfo.getScreenWidthOrHeight(getContext(), true);
            if (maxWidth < screenW) {
                maxScale = screenW / (float) sWidth();
            }
        }
        return imageLoaded;
    }
    ...
    private static class TileLoadTask extends AsyncTask<Void, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Void... params) {
            ...
            try {
                ...
                // 若OOM后，清理Glide缓存，重新加载图片
                Glide.get(CrashApplication.APP).clearDiskCache();
                Glide.get(CrashApplication.APP).clearMemory();
