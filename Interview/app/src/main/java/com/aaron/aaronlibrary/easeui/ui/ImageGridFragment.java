...
import com.aaron.aaronlibrary.easeui.domain.VideoEntity;
import com.aaron.aaronlibrary.easeui.utils.video.ImageCache;
import com.aaron.aaronlibrary.easeui.utils.video.ImageResizer;
import com.aaron.aaronlibrary.easeui.utils.video.Utils;
import com.aaron.aaronlibrary.easeui.widget.RecyclingImageView;
...
public class ImageGridFragment extends BaseFragment implements AdapterView.OnItemClickListener {
    ...
    protected void init() {
        ...
        mImageResizer.setLoadingImage(R.drawable.ease_default_image);
    ...
    private class ImageAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup container) {
            ...
            if (position == 0) {
                ...
                holder.imageView.setImageResource(R.drawable.ease_default_image);
