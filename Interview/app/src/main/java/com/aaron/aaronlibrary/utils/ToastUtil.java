...
public class ToastUtil {
    ...
    public static void  SetToast(Context context, int imageId, Spanned fromHtml, int duration) {
        ...
        if (context instanceof Activity)
            ...
            inflater = ((Activity) context).getLayoutInflater();
        View layout = inflater.inflate(com.aaron.interview.R.layout.toast_account_set,
          (ViewGroup) ((Activity) context).findViewById(com.aaron.interview.R.id.llToast));
        ImageView image = (ImageView) layout
          .findViewById(com.aaron.interview.R.id.tvImageToast);
        image.setBackgroundResource(imageId);
        TextView text = (TextView) layout.findViewById(com.aaron.interview.R.id.tvTitleToast);
    ...
    public static void setErrorToast(Context context, String content){
       SetToast(context , com.aaron.interview.R.mipmap.common_face_sad ,content , 1000);
    }
    /**
     * 笑脸吐司
     * @param context 上下文
    ...
    public static void setOKToast(Context context, String content){
        SetToast(context , com.aaron.interview.R.mipmap.common_face_ok ,content , 1000);
    }
    /**
     * 哭脸吐司
     * @param context 上下文
