...
public class ListDialog extends Dialog implements OnClickListener {
    ...
    public ListDialog(final Activity context, int theme) {
        super(context,theme);
        view = getLayoutInflater().from(getContext()).inflate(com.aaron.interview.R.layout.layout_dialog_list, null);
    ...
    public void findView() {
        rl_parent = (RelativeLayout) findViewById(com.aaron.interview.R.id.ac_dialog_parent);
        rl_content = (RelativeLayout) findViewById(com.aaron.interview.R.id.ac_dialog_list_rl);
        ll_buttons = (LinearLayout) findViewById(com.aaron.interview.R.id.ac_dialog_list_ll_btn);
        findAndSetClickListener(com.aaron.interview.R.id.ac_dialog_list_btn_cancel);
        menu_bg = findAndSetClickListener(com.aaron.interview.R.id.ac_dialog_list_bg);
    }
    ...
    public void init() {
        ...
        rl_parent.setBackgroundColor(mContext.getResources().getColor(com.aaron.interview.R.color.blank));
    ...
    public void onClick(View view) {
        int id = view.getId();
        if (id == com.aaron.interview.R.id.ac_dialog_list_btn_cancel || id == com.aaron.interview.R.id.ac_dialog_list_bg) {
            back();
        }
    }
    ...
    private void setButtons() {
        ...
        if (size > 0) {
            ...
            if (size > 1)
                btn_model.setBackgroundResource(com.aaron.interview.R.drawable.list_button_first_bg);
            ...
            for (int i = 1; i < size; i++) {
                ...
                if (i == size - 1)
                    button.setBackgroundResource(com.aaron.interview.R.drawable.list_button_last_bg);
                else
                    button.setBackgroundResource(com.aaron.interview.R.drawable.list_button_noradius_bg);
                button.setTextSize(TypedValue.COMPLEX_UNIT_PX, btn_model.getTextSize());
                button.setTextColor(mContext.getResources().getColor(com.aaron.interview.R.color.common_title));
                button.setOnClickListener(listButtonClickListener);
                button.setTag(i);
                ll_buttons.addView(button);
            }
        }
        int btnHeight = getDimen(com.aaron.interview.R.dimen.ac_dialog_list_btn_h)
                + getDimen(com.aaron.interview.R.dimen.ac_dialog_list_btn_margin_l_r);
        contentHeight = btnHeight * (size + 1) + getDimen(com.aaron.interview.R.dimen.ac_dialog_list_btn_margin_l_r);
    }
