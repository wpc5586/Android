...
//                        StringUtils.showToast(mContext, "");
    ...
    public int getContentLayoutId() {
        return com.aaron.interview.R.layout.activity_edittext_single;
    }

    @Override
    public void findView() {
        editText = (EditText) findViewById(com.aaron.interview.R.id.edittext_single_et);
        editText2 = (EditText) findViewById(com.aaron.interview.R.id.edittext_single_et2);
