...
import com.aaron.aaronlibrary.easeui.widget.EaseSidebar;
import com.aaron.aaronlibrary.easeui.widget.adapter.EaseContactAdapter;
...
public class PickAtUserActivity extends EaseBaseActivity{
    ...
    private void addHeadView(){
        if (listView.getHeaderViewsCount() == 0) {
            ...
            avatarView.setImageResource(R.drawable.em_groups_icon);
