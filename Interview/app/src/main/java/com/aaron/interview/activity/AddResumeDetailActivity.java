...
public class AddResumeDetailActivity extends InterViewActivity {

    private PtrClassicFrameLayout ptrFrameLayout;

    private RecyclerView recyclerView;

    private AddResumeDetailAdapter adapter;
    ...
    protected int getContentLayoutId() {
        return R.layout.activity_add_resume_detail;
    }
...
//        getData();
    ...
    private void setRecyclerView() {
        ...
        adapter = new AddResumeDetailAdapter(mContext);
    ...
    private class AddResumeDetailAdapter extends RecyclerView.Adapter<AddResumeDetailHolder> implements View.OnClickListener {
        ...
        public AddResumeDetailAdapter(Context context) {
        ...
        @Override
        public AddResumeDetailHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new AddResumeDetailHolder(LayoutInflater.from(context).
                    inflate(R.layout.item_add_resume, parent, false));
        }

        @Override
        public void onBindViewHolder(AddResumeDetailHolder holder, int position) {
            ...
            if (position == getItemCount() - 1) {
                ...
                holder.addView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        startMyActivity(AddResumeDetailActivity.class);
                    }
                });
            } else {
        ...
        public void onClick(final View v) {
            switch (v.getId()) {
                case R.id.parent:
                    AddResumeDetailHolder holder = (AddResumeDetailHolder) v.getTag();
                    if (onItemClickListener != null)
                        onItemClickListener.onItemClick(v, holder);
                    break;
//                case R.id.release_Btn:
//                    AddResumeDetailHolder holder1 = (AddResumeDetailHolder) v.getTag();
...
//                    break;
    ...
    static class AddResumeDetailHolder extends BaseViewHolder {
        ...
        public AddResumeDetailHolder(View itemView) {
            super(itemView);
